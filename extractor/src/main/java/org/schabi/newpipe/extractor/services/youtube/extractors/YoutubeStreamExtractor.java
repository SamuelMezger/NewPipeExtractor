...
public class YoutubeStreamExtractor extends StreamExtractor {
    ...
    @Nonnull
    @Override
    public List<TrackMetadata> getMusicInfos() throws ParsingException {
        String description = getDescription().getContent();

        if (description.endsWith("Auto-generated by YouTube.")) {
            // Try to parse YT Music auto-generated description which includes track metadata
            return Arrays.asList(YoutubeParsingHelper.parseYtMusicAutoGenDescription(description));
        } else {
